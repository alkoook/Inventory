...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('/orders/{id}/approve', \App\Livewire\Admin\Orders\Approve::class)->name('orders.approve');
        Route::get('/orders/{id}/reject', \App\Livewire\Admin\Orders\Reject::class)->name('orders.reject');
...
Route::prefix('client')
    ...
    ->group(function () {
        ...
        // Shopping cart - requires customer role
        Route::get('/cart', Card::class)->name('card')->middleware(['auth', 'customer']);
