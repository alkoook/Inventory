...
<head>
    ...
    <title>لوحة التحكم الزرقاء الحيوية</title>
            ...
            <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-180px)]">
                ...
                <a href="{{ route('admin.customers') }}" 
                   class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl smooth-transition text-dark-text hover:bg-primary-100/50">
                    ...
                    <span class="font-medium">الزبائن</span>
                </a>
            ...
            <header class="md:hidden topbar-margin sticky top-0 bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm" style="z-index: 30;">
                <div class="px-6 py-4 flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-dark-text">الرئيسية</h1> 
            ...
            <main class="p-6 min-h-screen">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-xl border border-primary-100 smooth-transition hover:shadow-primary-700/20">
                        ...
                        <p class="mt-4 text-3xl font-extrabold text-dark-text">45,678 ر.س</p>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-xl border border-primary-100 smooth-transition hover:shadow-primary-700/20">
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-500">الزبائن الجدد</p>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-xl border border-primary-100 smooth-transition hover:shadow-primary-700/20">
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-500">طلبات قيد المعالجة</p>
                        ...
                        <p class="text-xs text-gray-500 mt-1">بانتظار التأكيد</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-xl border border-primary-100 smooth-transition hover:shadow-primary-700/20">
                        ...
                        <p class="mt-4 text-3xl font-extrabold text-dark-text">1.2M ر.س</p>
                        <p class="text-xs text-gray-500 mt-1">القيمة الإجمالية للمنتجات</p>
                    </div>
