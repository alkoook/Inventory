    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <form wire:submit="save" class="p-6 space-y-4">
                ...
                <!-- رقم الهوية -->
                <div>
                    <label for="national_id" class="block mb-2 text-sm font-medium text-gray-700">رقم الهوية</label>
                    <input 
                        type="text" 
                        id="national_id" 
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl 
                               focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    >
                    @error('national_id') <span class="text-red-600 text-xs mt-1">{{ $message }}</span> @enderror
                </div>
