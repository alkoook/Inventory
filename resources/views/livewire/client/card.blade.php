                ...
                <div class="lg:col-span-2 space-y-4">
                    @foreach($cart->items as $item)
                        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-4 flex gap-4">
                            <!-- Image -->
                            <div class="w-24 h-24 bg-slate-100 rounded-lg flex-shrink-0 flex items-center justify-center">
                            ...
                            <div class="flex-1 flex flex-col justify-between">
                                ...
                                <div class="flex justify-between items-end mt-4">
                                    ...
                                    <div class="text-left">
                                        ...
                                        <p class="font-bold text-lg text-slate-900">{{ number_format($item->total_price, 0) }} ر.س</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6 sticky top-6">
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="border-t border-slate-200 pt-3 mt-3">
                                <div class="flex justify-between items-center font-bold text-lg text-slate-900">
                                    <span>الإجمالي</span>
                                    <span>{{ number_format($cart->total_amount, 0) }} ر.س</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <button 
                            ...
                            wire:confirm="هل أنت متأكد من إرسال الطلب؟"
                            class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg transition-colors shadow-sm"
                        >
                            إرسال الطلب
                        </button>
                    </div>
