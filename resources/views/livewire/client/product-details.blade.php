    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                <!-- Product Image -->
                <div class="relative bg-gray-100 rounded-2xl overflow-hidden aspect-square group border-2 border-blue-200 shadow-lg">
                    @if($product->image)
                    ...
                    <!-- Stock Badge -->
                    @if($product->stock > 0)
                        <div class="absolute top-4 right-4 bg-green-600 text-white text-sm font-bold px-4 py-2 rounded-full shadow-lg flex items-center gap-2">
                    ...
                    @else
                        <div class="absolute top-4 right-4 bg-red-600 text-white text-sm font-bold px-4 py-2 rounded-full shadow-lg">
                            غير متوفر
                        </div>
                    @endif
                </div>
